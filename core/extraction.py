...
# Helpers
def _extract_text_pymupdf(page: fitz.Page) -> str: # Extract selectable text from a PyMuPDF page object
...
def _ocr_page(page: fitz.Page) -> str: # Render page to image and run Tesseract OCR on it
